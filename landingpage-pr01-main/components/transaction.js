    ...
    let data = [
        {
            ...
            description: ' Notre application garantit la sécurité et la confidentialité de toutes les transactions effectuées par vos employés.'
        },
        {
            id: 2,
            title: 'Support Client Dédié',
            description: 'Notre équipe de support client est disponible 24h/24 et 7j/7 pour répondre à toutes les questions et résoudre les problèmes rapidement.'
        },
        {
            id: 3,
            title: 'Flexibilité de Paiement',
            description: 'Les employés peuvent choisir parmi une gamme d options de paiement pour rembourser leurs achats, adaptées à leurs préférences et capacités financières'
        }
    ]
