          ...
          <div className="md:col-span-6 relative h-full">
            ...
            <div className="flex items-center justify-center h-full py-12">
              <div className="relative w-96 h-96">
                ...
                <div className="absolute -bottom-20 left-1/2 transform -translate-x-1/2 bg-white rounded-xl shadow-lg py-4 px-6 z-40 flex w-full justify-between border border-gray-100">
                ...
                {/* Explainer text */}
                <div className="absolute -right-24 top-1/4 transform rotate-6 bg-white p-3 rounded-lg shadow-md border-l-4 border-primary-blue z-40 w-48">
                ...
                <div className="absolute -left-12 top-1/2 transform -translate-y-1/2 bg-green-50 p-3 rounded-lg shadow-md border-l-4 border-green-500 z-40 w-48">
                  <p className="text-xs text-gray-600">
