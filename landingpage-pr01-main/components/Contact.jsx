      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16 text-center max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary-blue to-primary-blue/80">
            Commencez Votre Parcours <span className="relative inline-block">
              Daret
              <svg className="absolute -bottom-2 left-0 w-full" height="6" viewBox="0 0 200 6" xmlns="http://www.w3.org/2000/svg">
                <path d="M0,3 C50,0 150,0 200,3" stroke="#1A5276" strokeWidth="4" fill="none" strokeLinecap="round" />
              </svg>
            </span>
          </h2>

          <p className="text-lg text-gray-600 mt-6">
            <span className="font-semibold">Prêt à transformer votre façon d'épargner?</span> Notre équipe d'experts
            est disponible pour répondre à vos questions et vous guider dans la création
            ou la gestion de votre groupe Daret.
          </p>
        </div>
          ...
          <div className="lg:col-span-3 bg-white p-10 rounded-2xl shadow-xl border border-gray-100 relative overflow-hidden">
            ...
            {formStatus.submitted ? (
              <div className="text-center py-16 relative z-10">
                <div className={`w-20 h-20 mx-auto ${formStatus.error ? 'bg-red-100':'bg-green-100'} rounded-full flex items-center justify-center mb-6 shadow-inner`}>
                  {!formStatus.error ? <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                {!formStatus.error && <h3 className="text-2xl font-bold text-banking-dark mb-3">
                  Merci pour votre message!
                </h3>}
                <p className="text-gray-600 text-lg max-w-md mx-auto">{formStatus.message}</p>
                <button
                  onClick={() =>
                    setFormStatus({
                      submitted: false,
              ...
              <form onSubmit={handleSubmit} className="relative z-10">
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-banking-dark mb-2">Comment pouvons-nous vous aider?</h3>
                  <p className="text-gray-600">Partagez vos questions ou besoins et nous reviendrons vers vous rapidement</p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  <div className="mb-4 sm:mb-0">
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-sm text-gray-600">Vos informations sont sécurisées et ne seront jamais partagées</span>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="bg-white p-6">
                <h3 className="font-bold text-xl text-banking-dark mb-4 text-center">Notre Bureau Principal</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start border-b border-gray-100 pb-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@berberpay.com" className="text-primary-blue hover:underline mt-1 inline-block">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-banking-dark">Téléphone</h4>
                      <div className="space-y-1 mt-1">
                        <a href="tel:+212602534811" className="text-primary-blue hover:underline inline-block">
                          +212 602 534 811
                        </a>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-medium text-banking-dark">Support Chat en Direct</h3>
            ...
            <div className="bg-gradient-to-br from-primary-blue/5 to-primary-blue/10 p-6 rounded-2xl shadow-lg relative overflow-hidden">
              ...
              <p className="text-sm text-gray-600 mb-3 relative z-10">
                Notre équipe propose un support complet en arabe pour votre confort
              </p>
              <div className="bg-white/50 backdrop-blur-sm p-4 rounded-xl border border-primary-blue/10 relative z-10">
                <p className="font-arabic text-right text-base text-primary-blue font-medium leading-relaxed">
                  فريقنا متاح للإجابة على أسئلتكم باللغة العربية. لا تترددوا في التواصل معنا
                </p>
                <p className="text-xs text-gray-500 mt-1">
                  Notre équipe est disponible pour répondre à vos questions en arabe. N'hésitez pas à nous contacter.
                </p>
              </div>
            </div>
        ...
        <div className="mt-20 bg-primary-blue rounded-2xl shadow-xl overflow-hidden relative">
          ...
          <div className="lg:flex items-center">
            <div className="lg:w-2/3 p-10 lg:p-16 relative z-10">
              <h3 className="text-3xl font-bold text-white mb-4">Prêt à rejoindre la révolution financière Daret ?</h3>
              <p className="text-white/80 text-lg mb-8">
                Créez ou rejoignez un groupe Daret dès aujourd'hui et découvrez une nouvelle façon d'épargner collectivement.
              </p>
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="#download" className="px-8 py-4 bg-white text-primary-blue font-bold rounded-xl shadow-lg hover:shadow-xl transition duration-300 text-center">
                  Télécharger l'application
                </a>
                <a href="#contact-form" className="px-8 py-4 bg-white/20 backdrop-blur-sm text-white border border-white/30 font-medium rounded-xl shadow-lg hover:bg-white/30 transition duration-300 text-center">
                  Nous contacter
                </a>
              </div>
            </div>
